...
def test_command_line_code():
    ...
    proc = Spidermonkey(code=b'print("Hello")')
...
def test_script_args():
    ...
    proc = Spidermonkey(code=b'print(scriptArgs)',
                        script_args=(b'Hello', b'World'))
    stdout, stderr = proc.communicate('')
...
def test_extra_flags():
    ...
    proc = Spidermonkey(extra_flags=('-e', b'print(scriptArgs)'),
                        script_args=(b'Hello', b'World'))
    stdout, stderr = proc.communicate('')
...
def test_compileonly():
    ...
    with pytest.raises(AssertionError):
        Spidermonkey(compile_only=True, code=b"print('Hello')")
